...
class Q_DICT:
    def __init__(self):
        # Init Q-dict for single object ball
        cueball_s_start=[0.00, 0.00]
        objectball_s_start=[0.00, 0.00]
        theta_start=0.00
        power_start=0.00
        reward=0.00
        self.Q_dict = {f'{cueball_s_start}, {objectball_s_start}, {theta_start}, {power_start}': reward}
